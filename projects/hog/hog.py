...
def piggy_points(score):
    ...
    if score<100:
        a=abs((score//10)-(score%10))
    else:
        a=abs((score//10%10)-(score%10))
    return a+4
...
def more_boar(player_score, opponent_score):
    ...
    if k<10:
        ...
        b=(k//10)%10
        c=k%10
        max_countk=max(a,b,c)
        min_countk=min(a,b,c)

    if max_count>max_countk and min_count<min_countk:
        return True
    else:
        return False
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:
        if who==0:
            ...
            if more_boar(score0,score1)==True:
                who = 0
            else:
                who = 1
        else:
            ...
            say=say(score0,score1)
            if more_boar(score1,score0)==True:
                who=1
            else:
                who = 0
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def commentary(score0, score1, last_score=last_score, running_high=running_high, who=who):
        if who ==0:
...
def make_averaged(original_function, trials_count=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def functionnew(*args):
        fresh,total=0,0
        while fresh < trials_count:
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    max_dice = 0
    while dice_num>0:
        total=make_averaged(roll_dice, trials_count=1000)(dice_num,dice)
        if total>max_dice:
            max_dice=total
            max_num_dice=dice_num         
        dice_num-=1
    return max_num_dice
    # END PROBLEM 9
...
def more_boar_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    score_add=piggy_points(opponent_score)
    score_total=score+score_add
    if piggypoints_strategy(score=score,opponent_score=opponent_score,cutoff=cutoff, num_rolls=num_rolls)==0 or more_boar(score_total,opponent_score)==True:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
